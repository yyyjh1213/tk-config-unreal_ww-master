...
class UnrealAssetPublishPlugin(HookBaseClass):
    ...
    def _get_publish_path(self, settings, item):
        ...
        fields = {
            ...
            "sg_asset_type": item.context.entity.get("sg_asset_type", ""),
            "Asset": item.context.entity.get("code", ""),
            "Step": item.context.step.get("short_name", ""),
    ...
    def publish(self, settings, item):
        ...
        destination_path = self._get_publish_path(settings, item)
